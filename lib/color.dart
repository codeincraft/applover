...
class AppColor{
  ...
  static  Color gradientFirst=const Color(0xFF880E4F);
  static  Color gradientSecond=const Color(0xFFE91E63);
  static  Color homePageTitle=const Color(0xFF302f51);
  static  Color homePageSubtitle=const Color(0xFF414160);
  static  Color homePageDetail=const Color(0xFF880E4F);
  ...
  static Color secondPageContainerGradient1stColor= const Color(0xFFFF4081);
  static Color secondPageContainerGradient2ndColor= const Color(0xFFF50057);
